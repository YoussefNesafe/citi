  ...
  return (
    <footer>
      ...
      <section className='flex flex-col justify-center items-start desktop:grid desktop:grid-cols-8 desktop:grid-rows-5  gap-[9.32vw] tablet:gap-[5vw] desktop:gap-[1.56vw]'>
        <ImageWrapper src='/images/shared/primary-bg.png' alt='bg' width={1920} height={631} className='w-[100vw] h-[80%] tablet:h-[85%] desktop:h-[60%] object-cover absolute bottom-0 left-0' />
